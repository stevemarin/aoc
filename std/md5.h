...
// copied from: https://github.com/Zunawe/md5-c
#ifndef MD5_H
#define MD5_H
...
static uint32_t S[64] = {7,  12, 17, 22, 7,  12, 17, 22, 7,  12, 17, 22, 7,  12, 17, 22, 5,  9,  14, 20, 5,  9,
...
static void md5String(char *input, uint8_t *result) {
    MD5Context ctx;
    md5Init(&ctx);
...
// static void md5File(FILE *file, uint8_t *result) {
